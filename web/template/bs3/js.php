...
$(document).ready(function(){
  ...
  $("body").append("<div class=center align=center>Anything about the Problems, Please Contact <a href='mailto:joewttx@163.com'>JOE</a></div>");
  $("body").append("<div id=footer class=center align=center>GPLv2 licensed by <a href='https://github.com/zhblue/hustoj' >HUSTOJ</a> "+(new Date()).getFullYear()+" </div>");
  $("body").append("<div class=center align=center><a href=http://www.miitbeian.gov.cn/ target=_blank>湘ICP备16020273号 <a/></div>");
  //$("body").append("<div class=center align=center><a href='https://www.duba.com/?un_454974_116387' title='每天点击一次开发者可获得￥0.06' target='_blank'>捐助系统开发者</a></div>");
});
